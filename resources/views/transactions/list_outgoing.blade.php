    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        Outgoing Transactions from the {!!Auth::user()->assigned_to['description']!!}
                    </h2>
                </div>
                <div class="body">
                    @if(count($status)>0)
                        ...
                        <table id="transaction_table" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            <thead>
                                <tr>
                                    <th style="width: 3%">#</th>
                                    <th>Particulars</th>
                                    <th style="width: 15%">Forwarded To</th>
                                    {{-- <th style="width: 15%">Date Forwarded</th> --}}
                                ...
                                @if (count($status)>0)
                                    @foreach ($status as $i => $s)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($j != " ")
                                                    <a href="/show_transaction/{!!$s->transaction->id!!}">View</a>
                                                @else
                                                    {{$j}}
                                                @endif
                                            </td>
                ...
                <div class="modal-body">
                    <div class="row clearfix">
                        <form target="_blank" action="/print_transactions" method="GET">
                            ...
                            <div class="col-xs-12">
                                {{--the value 3 means print outgoing trasactions from the office--}}

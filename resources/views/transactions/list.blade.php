    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        Transactions from the {!!Auth::user()->assigned_to['description']!!}
                    </h2>
                </div>
                <div class="body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    {{-- {{ substr_count( $transaction->description, "\n" )+2 }} --}}
                                                    <textarea rows="4" class="form-control no-resize" readonly>{!!$transaction->description!!}</textarea>
                                                </div>
                                            </td>
                ...
                <div class="modal-body">
                    <div class="row clearfix">
                        <form target="_blank" action="/print_transactions" method="GET">
                            ...
                            <div class="col-xs-12">
                                {{--the value 1 means print trasactions from office--}}

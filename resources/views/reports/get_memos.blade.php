    ...
    <div class="container-fluid">
        <div class="col-xs-9 col-sm-9 col-md-6 col-lg-6">
            <div class="row clearfix">
                <div class="card">
                    <div class="header"><h2>GET MEMOS</h2></div>
                    <div class="body">
                        <form action="/reports/memos/list" method="GET">
                            <div class="row clearfix">
                                {{--Displayed for Records Office only--}}
                                    ...
                                    @if (count($offices)>0)
                                        <div class="col-xs-12">
                                            ...
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <select id="offices" class="form-control show-tick" name="id" title="Select Office:" required>
                                ...
                                @endif
                                <div class="col-xs-12">
                                    <h4 class="card-inside-title">Type: </h4>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select id="offices" class="form-control show-tick" name="type" title="Select Type:" required>
                                                <option value="1">From the Office</option>
                                                <option value="2">For the Office</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>

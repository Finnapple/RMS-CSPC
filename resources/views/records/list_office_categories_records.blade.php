        ...
        <div class="card">
            <div class="body">
                <ol class="breadcrumb">
                    ...
                    <li><a href="/records/offices/{!!$office->id!!}/categories/">{!!$office->description!!}</a></li>
                ...
                {{-- <div class="align-right button-demo">
                    <button type="button" class="btn btn-sm bg-light-blue waves-effect" data-toggle="modal" data-target="#addModal" 
                        data-category_id="{!!$category->id!!}" data-office_id="{!!$office->id!!}">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-center">
                                            <a href="#" data-toggle="modal" data-target="#viewModal" data-code="{!!$record->category->code!!}) {!!$record->category->description!!}" 
                                                data-upload_date="{!!$record->upload_date!!}" data-start_date="{!!$record->start_date!!}" data-description="{!!$record->description!!}" data-offices="{{$record->offices}}" data-originating_office="{{$record->originating_office->description}}">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">ADD NEW RECORD CATEGORY</h4>
                </div>
                ...
                <div class="modal-body">
                    {{-- <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <div class="demo-radio-button">
                                    <h5>{!!$category->isInternal ? 'Internal' : 'External' !!}</h5>
                                </div>
                            </div>
                        </div>
                    </div> --}}
                    ...
                    <div class="col-sm-6">
                        <h5 class="card-inside-title">Upload Date: </h5>
                        <div class="form-group">
                            <div class="form-line">
                                <h5 id="upload_date"></h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6" style="{!! $category->type !=3 ? 'display:block' : 'display:none' !!}">
                        <h5 class="card-inside-title">Originating Office: </h5>
                        <div class="form-group">
                            <div class="form-line">
